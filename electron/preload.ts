...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  aiListModels: (args: any) => ipcRenderer.invoke('ai-list-models', args),
  aiAnalyzeIssue: (args: any) => ipcRenderer.invoke('ai-analyze-issue', args),
  aiAnalyze: (args: any) => ipcRenderer.invoke('ai-analyze', args),
  aiCriticality: (args: any) => ipcRenderer.invoke('ai-criticality', args),
  aiTestRunSuggestions: (args: any) => ipcRenderer.invoke('ai-test-run-suggestions', args),
  aiSmokeSubset: (args: any) => ipcRenderer.invoke('ai-smoke-subset', args),
