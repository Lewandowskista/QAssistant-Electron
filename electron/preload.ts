...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  upsertProjectTestPlan: (projectId: string, plan: any) => ipcRenderer.invoke('upsert-project-test-plan', { projectId, plan }),
  deleteProjectTestPlan: (projectId: string, planId: string) => ipcRenderer.invoke('delete-project-test-plan', { projectId, planId }),
  upsertProjectEnvironment: (projectId: string, env: any) => ipcRenderer.invoke('upsert-project-environment', { projectId, env }),
  deleteProjectEnvironment: (projectId: string, envId: string) => ipcRenderer.invoke('delete-project-environment', { projectId, envId }),
  upsertProjectChecklist: (projectId: string, checklist: any) => ipcRenderer.invoke('upsert-project-checklist', { projectId, checklist }),
  deleteProjectChecklist: (projectId: string, checklistId: string) => ipcRenderer.invoke('delete-project-checklist', { projectId, checklistId }),
  upsertProjectTestRunSession: (projectId: string, session: any) => ipcRenderer.invoke('upsert-project-test-run-session', { projectId, session }),
  deleteProjectTestRunSession: (projectId: string, sessionId: string) => ipcRenderer.invoke('delete-project-test-run-session', { projectId, sessionId }),
