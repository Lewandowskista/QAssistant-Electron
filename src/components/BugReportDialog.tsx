                            ...
                            <div className="flex items-center justify-between px-3 py-2 border-b border-ui">
                                <div className="flex items-center gap-2">
                                    ...
                                    {duplicatesChecked && duplicates.length === 0 && (
                                        <span className="text-[9px] font-bold uppercase tracking-widest px-1.5 py-0.5 rounded bg-state-success-soft text-state-success">No duplicates found</span>
                                    )}
                                    {duplicates.length > 0 && (
                                        <span className="text-[9px] font-bold uppercase tracking-widest px-1.5 py-0.5 rounded bg-state-warning-soft text-state-warning">{duplicates.length} possible duplicate{duplicates.length !== 1 ? 's' : ''}</span>
                                    )}
                                </div>
                                <Button
                                    type="button"
                                    ...
                                    className="h-7 text-[10px] font-bold text-brand hover:bg-qa-accent/10 gap-1.5"
                                >
