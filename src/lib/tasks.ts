...
const DEFAULT_TASK_COLUMNS: TaskBoardColumn[] = [
    { id: "backlog", title: "BACKLOG", color: "bg-line-strong", textColor: "text-soft" },
    { id: "todo", title: "TODO", color: "bg-line-strong", textColor: "text-muted-ui" },
    { id: "in-progress", title: "IN PROGRESS", color: "bg-state-info", textColor: "text-state-info" },
    { id: "in-review", title: "IN REVIEW", color: "bg-primary", textColor: "text-brand" },
    { id: "done", title: "DONE", color: "bg-state-success", textColor: "text-state-success" },
    { id: "canceled", title: "CANCELED", color: "bg-state-danger", textColor: "text-state-danger" },
    { id: "duplicate", title: "DUPLICATE", color: "bg-state-warning", textColor: "text-state-warning" }
]
